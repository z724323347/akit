...
import 'package:akit/kit/apm/launch/model.dart';
import 'package:akit/kit/apm/launch/route_observer.dart';
...
class _PageLaunchPageState extends State<PageLaunchPage> {
  ...
  void openCounter() {
    ...
    aKitOverlayKey.currentState?.insert(PageLaunchKit._overlayEntry);
  }
}
