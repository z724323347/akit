...
import 'package:akit/kit/apm/leaks/leaks_doctor_conf.dart';
import 'package:akit/kit/apm/vm/vm_service_toolset.dart';
...
class LeaksDoctor {
  ...
  // 比如runZone就会延时释放
  Future<void> memoryLeakScan({String? group, int delay = 0}) async {
  ...
  void addObserved(Object obj,
    ...
    _leakController.postLeaksEvent(
        LeaksDoctorEvent(LeaksDoctorEventType.AddObject, data: group));
