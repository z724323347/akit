...
class ColorPickerKit extends VisualKit {
  ...
  void _show(BuildContext? context, OverlayEntry? entrance) {
    ...
    isShown = true;
    aKitOverlayKey.currentState?.insert(_focusEntry, below: entrance);
    aKitOverlayKey.currentState?.insert(_infoEntry, below: _focusEntry);
  }
...
class MagnifierPainter extends CustomPainter {
  ...
  void _drawCircle(Canvas canvas, Size size) {
    final Paint paint = Paint()
      ...
      ..color = color;
    canvas.drawCircle(size.center(Offset(0, 0)), size.longestSide / 2, paint);
  }
