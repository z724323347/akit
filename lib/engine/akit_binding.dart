...
import 'package:akit/kit/apm/method_channel_kit.dart';
...
class AKitWidgetsFlutterBinding extends WidgetsFlutterBinding
    with AKitServicesBinding {
  static WidgetsBinding? ensureInitialized() {
    if (WidgetsBinding.instance == null) {
      AKitWidgetsFlutterBinding();
    }
    return WidgetsBinding.instance;
  }
}

mixin AKitServicesBinding on BindingBase, ServicesBinding {
  @override
  BinaryMessenger createBinaryMessenger() {
    return AKitBinaryMessenger(super.createBinaryMessenger());
  }
}
...
class AKitBinaryMessenger extends BinaryMessenger {
  AKitBinaryMessenger(this.origin);
